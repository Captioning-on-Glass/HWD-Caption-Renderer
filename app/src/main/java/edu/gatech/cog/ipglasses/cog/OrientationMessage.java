...
public final class OrientationMessage extends Table {
  ...
  public float gyroX() { int o = __offset(10); return o != 0 ? bb.getFloat(o + bb_pos) : 0.0f; }
  public float gyroY() { int o = __offset(12); return o != 0 ? bb.getFloat(o + bb_pos) : 0.0f; }
  public float gyroZ() { int o = __offset(14); return o != 0 ? bb.getFloat(o + bb_pos) : 0.0f; }
  ...
  public static void startOrientationMessage(FlatBufferBuilder builder) { builder.startTable(6); }
  ...
  public static void addGyroX(FlatBufferBuilder builder, float gyroX) { builder.addFloat(3, gyroX, 0.0f); }
  public static void addGyroY(FlatBufferBuilder builder, float gyroY) { builder.addFloat(4, gyroY, 0.0f); }
  public static void addGyroZ(FlatBufferBuilder builder, float gyroZ) { builder.addFloat(5, gyroZ, 0.0f); }
